...
<title>Gestion CPU</title>
</head>
<body id="page-top">
	<div id="content-wrapper" class="d-flex flex-column">

		Sélectionner un critère de recherche (par Nom du processor ou
		generation Cpu ou vitesse) :
		<div>
			...
			<form action=CpuListController method="GET">
				...
				<table>
					<tr>
						...
						<td><input type="text" name="motDeRecherche"
							value="<%=motDeRecherche%>" /></td>
		...
		<p>
			<a href="CpuForm.jsp" class="btn btn-lg btn-primary">Ajouter</a>
		</p>
		<hr>
			...
			<%
				...
				if (cpus != null) {
					...
					for (int i = 0; i < cpus.size(); i++) {
						...
						out.print("<td>  <a class='btn btn-info' href ='FormCpuAction?id=" + ((Cpu) cpus.get(i)).getId_cpu() + "&mode=Edition"
								+ "'>Modifier</a> </td>");
						out.println("<td>  <a class='btn btn-danger' href ='FormCpuAction?id=" + ((Cpu) cpus.get(i)).getId_cpu()
								+ "&mode=Suppression"
								+ "'  onclick='return confirm(\"Voulez vous vraiment supprimer ce produit ?\")'      >Supprimer</a> </td>");
						out.println("</tr>");
					}
